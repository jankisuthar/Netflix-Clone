...
function Questions(props) {
    const data=()=>{
        ...
        // console.log(a);
        a.classList.toggle('newcls');
        
    }
    return (
        <>
            <div className="container-fluid questions text-center">
                <h1 className='pt-5'>Frequently Asked Questions</h1>

                {/* accordian */}
                <div className="container accordian mt-5">
                <div className="accordion" id="accordionExample">
  <div className="accordion-item">
    <h2 className="accordion-header" id="headingOne">
      <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
      What is Netflix?<i class="fa-solid fa-plus plus" id='plus' onClick={data}></i>
      </button>
    </h2>
...
<div className="header-content text-center text-white mt-5 py-5">
              
                 <h4 className='mt-3'>Ready to watch? Enter your email to create or restart your membership.</h4>
                 <form class="d-flex mt-3 get-search">
